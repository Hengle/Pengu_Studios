...
public class PlayerController : MonoBehaviour
{
    ...
    public void CheckForTurns()
    {
        ...
        if(_dotProductForward < 1 && _dotProductForward > .5f)
        {
            forwardVelocity = 3;
        }
        else if (_dotProductForward == -.00000004214685f || _dotProductForward == 0)
        {
            isTurning = true;
            StartCoroutine("Turn");
        }
