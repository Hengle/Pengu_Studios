	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 WorldPosition2_g836 = WorldPosition;
				...
				float simplePerlin3D193_g836 = snoise( ( ( WorldPosition2_g836 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * _TimeParameters.x ) ) );
				...
				float3 Emission = lerpResult82_g681;
				float3 Specular = 0.5;
				float Metallic = 0;
