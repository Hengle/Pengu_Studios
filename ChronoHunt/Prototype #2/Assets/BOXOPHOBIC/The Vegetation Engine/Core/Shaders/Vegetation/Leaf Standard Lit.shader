	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half3 VertexPos40_g32415 = temp_output_2283_0_g32107;
				...
				half MotionAmplitude203095_g32107 = _MotionAmplitude_20;
				float ObjectData20_g32404 = 3.14;
				float Bounds_Radius121_g32107 = _MaxBoundsInfo.x;
				float WorldData19_g32404 = Bounds_Radius121_g32107;
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g32404 = WorldData19_g32404;
				#else
				float staticSwitch14_g32404 = ObjectData20_g32404;
				#endif
				float Motion_Max_Rolling1137_g32107 = staticSwitch14_g32404;
				...
				half Wind_Power_203109_g32107 = lerpResult376_g32350;
				half Mesh_Motion_260_g32107 = v.ase_texcoord3.y;
				...
				half Motion_Use20162_g32107 = _Motion_20;
				...
				float temp_output_116_0_g32432 = Variation3073_g32107;
				...
				half Wind_Power2223_g32107 = Wind_Power369_g32350;
				float lerpResult118_g32432 = lerp( 0.25 , 0.75 , Wind_Power2223_g32107);
				...
				half Motion_Selective3182_g32107 = lerpResult111_g32432;
				half Input_Speed62_g32377 = _MotionSpeed_20;
				float mulTime354_g32377 = _TimeParameters.x * Input_Speed62_g32377;
				float temp_output_342_0_g32377 = ( ( _MotionVariation_20 * Variation3073_g32107 ) * v.ase_color.r );
				...
				half Motion_Rolling138_g32107 = ( ( MotionAmplitude203095_g32107 * Motion_Max_Rolling1137_g32107 ) * ( Wind_Power_203109_g32107 * Mesh_Motion_260_g32107 * Global_NoiseTex_R34_g32107 * Motion_Use20162_g32107 * Motion_Selective3182_g32107 ) * sin( ( mulTime354_g32377 + Motion_Variation284_g32377 + Motion_Scale287_g32377 ) ) );
				half Angle44_g32415 = Motion_Rolling138_g32107;
				...
				half Input_Amplitude58_g32431 = ( _MotionAmplitude_30 * Bounds_Radius121_g32107 * 0.1 );
				half Global_NoiseTex_G38_g32107 = break142_g32370.g;
				half Global_NoiseTex_B132_g32107 = break142_g32370.b;
				half Mesh_Motion_3144_g32107 = v.ase_texcoord3.z;
				half Motion_Use302011_g32107 = _Motion_30;
				float lerpResult378_g32350 = lerp( 0.5 , 1.0 , Wind_Power369_g32350);
				half Wind_Power_303112_g32107 = lerpResult378_g32350;
				half3 Motion_Leaves1988_g32107 = ( ( sin( ( ( ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z ) * Motion_Scale321_g32431 ) + mulTime350_g32431 + Motion_Variation330_g32431 ) ) * Input_Amplitude58_g32431 * v.ase_normal ) * ( ( Global_NoiseTex_G38_g32107 + Global_NoiseTex_B132_g32107 ) * Mesh_Motion_3144_g32107 * Motion_Use302011_g32107 * Wind_Power_303112_g32107 ) );
				...
				half Input_Amplitude58_g32419 = ( _MotionAmplitude_32 * Bounds_Radius121_g32107 * 0.1 );
				float3 appendResult345_g32419 = (float3(v.ase_color.r , ( 1.0 - v.ase_color.r ) , v.ase_color.r));
				half Motion_Use322013_g32107 = _Motion_32;
				half Wind_Power_323115_g32107 = lerpResult376_g32350;
				half3 Motion_Flutter263_g32107 = ( ( sin( ( ( ( ase_worldPos.x + ase_worldPos.y + ase_worldPos.z ) * Motion_Scale321_g32419 ) + mulTime349_g32419 + Motion_Variation330_g32419 ) ) * Input_Amplitude58_g32419 * appendResult345_g32419 ) * ( ( Global_NoiseTex_R34_g32107 + Global_NoiseTex_B132_g32107 ) * Mesh_Motion_3144_g32107 * Motion_Use322013_g32107 * Wind_Power_323115_g32107 ) );
				half Wind_Mode3167_g32107 = TVE_WindMode;
				float3 lerpResult3168_g32107 = lerp( v.vertex.xyz , ( ( ( VertexPosRotationAxis50_g32421 + ( VertexPosOtherAxis82_g32421 * cos( Angle44_g32421 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g32421 ) * sin( Angle44_g32421 ) ) ) + Motion_Leaves1988_g32107 ) + Motion_Flutter263_g32107 ) , Wind_Mode3167_g32107);
				float3 Vertex_Motion_Object833_g32107 = lerpResult3168_g32107;
				float3 appendResult2047_g32107 = (float3(Motion_Rolling138_g32107 , 0.0 , -Motion_Rolling138_g32107));
				float3 appendResult2043_g32107 = (float3(Motion_X216_g32107 , 0.0 , Motion_Z190_g32107));
				float3 lerpResult3173_g32107 = lerp( v.vertex.xyz , ( ( ( ( v.vertex.xyz + appendResult2047_g32107 ) + appendResult2043_g32107 ) + Motion_Leaves1988_g32107 ) + Motion_Flutter263_g32107 ) , Wind_Mode3167_g32107);
			...
			half4 frag ( VertexOutput IN , half ase_vface : VFACE ) : SV_Target
			{
				...
				float3 temp_output_13_0_g32316 = float3(0,0,1);
				float3 switchResult12_g32316 = (((ase_vface>0)?(temp_output_13_0_g32316):(( temp_output_13_0_g32316 * _render_normals_options ))));
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal775_g32107 = switchResult12_g32316;
				float3 worldNormal775_g32107 = normalize( float3(dot(tanToWorld0,tanNormal775_g32107), dot(tanToWorld1,tanNormal775_g32107), dot(tanToWorld2,tanNormal775_g32107)) );
				float dotResult777_g32107 = dot( worldNormal775_g32107 , TVE_MainLightDirection );
				#ifdef UNITY_PASS_FORWARDADD
				float staticSwitch1604_g32107 = 0.0;
				#else
				float staticSwitch1604_g32107 = max( -dotResult777_g32107 , 0.0 );
				#endif
				half Mask_Subsurface_Normal870_g32107 = staticSwitch1604_g32107;
				half3 Subsurface_Deferred1693_g32107 = ( Subsurface_Transmission884_g32107 * ( Mask_Subsurface_View782_g32107 + Mask_Subsurface_Normal870_g32107 ) );
				...
				half3 Blend_NormalRaw1051_g32107 = Main_Normal137_g32107;
				float3 switchResult1063_g32107 = (((ase_vface>0)?(Blend_NormalRaw1051_g32107):(( Blend_NormalRaw1051_g32107 * float3(-1,-1,-1) ))));
				half Overlay_Contrast1405_g32107 = _OverlayContrastValue;
				float3 appendResult1439_g32107 = (float3(Overlay_Contrast1405_g32107 , Overlay_Contrast1405_g32107 , 1.0));
				float3 tanNormal178_g32107 = ( switchResult1063_g32107 * appendResult1439_g32107 );
				float3 worldNormal178_g32107 = float3(dot(tanToWorld0,tanNormal178_g32107), dot(tanToWorld1,tanNormal178_g32107), dot(tanToWorld2,tanNormal178_g32107));
				...
				float lerpResult1065_g32107 = lerp( 1.0 , IN.ase_color.r , _OverlayVariationValue);
				half Overlay_Commons1365_g32107 = ( temp_output_1025_0_g32107 * lerpResult1065_g32107 );
				half Overlay_Mask269_g32107 = saturate( ( saturate( worldNormal178_g32107.y ) - ( 1.0 - Overlay_Commons1365_g32107 ) ) );
				...
				half Mesh_Occlusion318_g32107 = IN.ase_color.g;
				float saferPower1201_g32107 = max( Mesh_Occlusion318_g32107 , 0.0001 );
				float3 lerpResult2945_g32107 = lerp( (_VertexOcclusionColor).rgb , temp_cast_12 , saturate( pow( saferPower1201_g32107 , ( _VertexOcclusionValue + _OcclusionCat ) ) ));
				half3 Vertex_Occlusion648_g32107 = lerpResult2945_g32107;
				...
				float Mesh_Variation16_g32107 = IN.ase_color.r;
				float lerpResult2262_g32107 = lerp( 0.9 , Mesh_Variation16_g32107 , _LeavesVariationValue);
				half Global_ExtrasTex_R174_g32107 = break49_g32352.x;
				float lerpResult2624_g32107 = lerp( 1.0 , Global_ExtrasTex_R174_g32107 , _GlobalLeaves);
				half AlphaTreshold2132_g32107 = _Cutoff;
				half Mask_Leaves315_g32107 = ( ( (lerpResult2262_g32107*0.5 + 0.5) - ( 1.0 - ( lerpResult2624_g32107 * _LocalLeaves ) ) ) + AlphaTreshold2132_g32107 );
				half Alpha5_g32414 = ( Main_AlphaRaw1203_g32107 * Mask_Leaves315_g32107 );
				...
				float3 Albedo = ( temp_output_410_0_g32107 * Vertex_Occlusion648_g32107 );
...
/*ASEBEGIN
Version=18600
1927;7;1906;1015;2839.04;1144.184;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;619;-2176,-384;Inherit;False;Base Shader;1;;32107;856f7164d1c579d43a5cf4968a75ca43;50,1300,1,1298,1,1271,1,1708,1,1962,1,1712,3,1964,1,1969,1,1719,1,893,1,1745,1,1742,1,1718,1,1717,1,1715,1,1714,1,916,1,1949,1,1762,0,1763,0,1776,1,1646,1,1690,1,1757,1,3221,3,1981,0,2807,1,2953,1,3243,0,2172,0,2658,0,1734,0,1737,0,1733,0,1736,0,1968,0,1966,0,1735,0,878,0,1550,0,860,1,2750,0,2260,1,2261,1,2054,1,2032,1,2036,1,2060,1,2062,1,2039,1;0;15;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;529;FLOAT;530;FLOAT;531;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;653;FLOAT;629;FLOAT3;534
...
ASEEND*/
//CHKSM=CA30C5C96FA1B0439B7468E184AC9BD2FE2D2B25
