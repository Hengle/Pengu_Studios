...
Shader "BOXOPHOBIC/The Vegetation Engine/Vegetation/Cross Subsurface Lit"
{
	Properties
	{
		...
		[ASEBegin][StyledBanner(Cross Subsurface Lit)]_Banner("Banner", Float) = 0
		...
		[HideInInspector]_Float7("Float 7", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float3 temp_output_2283_0_g32155 = ( v.vertex.xyz - Mesh_PivotsOS2291_g32155 );
				half3 VertexPos40_g32740 = temp_output_2283_0_g32155;
				...
				float WorldData19_g32815 = ( Bounds_Height374_g32155 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g32815 = WorldData19_g32815;
				#else
				float staticSwitch14_g32815 = ObjectData20_g32815;
				#endif
				float Motion_Max_Bending1133_g32155 = staticSwitch14_g32815;
				...
				half Wind_Power_103106_g32155 = Wind_Power369_g32778;
				...
				half2 Wind_DirectionOS39_g32155 = (temp_output_339_0_g32778).xz;
				...
				half Global_NoiseTex_R34_g32155 = break142_g32799.r;
				...
				#endif
				half Variation3073_g32155 = staticSwitch14_g32762;
				half Motion_Variation284_g32735 = ( _MotionVariation_10 * Variation3073_g32155 );
				...
				half Input_Turbulence327_g32735 = Global_NoiseTex_R34_g32155;
				float2 lerpResult321_g32735 = lerp( Sine_MinusOneToOne281_g32735 , temp_cast_11 , Input_Turbulence327_g32735);
				half2 Motion_Bending2258_g32155 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g32155 ) * Wind_Power_103106_g32155 * Wind_DirectionOS39_g32155 * Motion_Use1056_g32155 * Global_NoiseTex_R34_g32155 * lerpResult321_g32735 );
				half Motion_UseInteraction2097_g32155 = _Motion_Interaction;
				half Motion_InteractionMask66_g32155 = break322_g32778.w;
				...
				half Angle44_g32723 = -Motion_X216_g32155;
				half Wind_Mode3167_g32155 = TVE_WindMode;
				float3 lerpResult3168_g32155 = lerp( v.vertex.xyz , ( VertexPosRotationAxis50_g32723 + ( VertexPosOtherAxis82_g32723 * cos( Angle44_g32723 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g32723 ) * sin( Angle44_g32723 ) ) ) , Wind_Mode3167_g32155);
				float3 Vertex_Motion_Object833_g32155 = lerpResult3168_g32155;
				float3 temp_output_3474_0_g32155 = ( v.vertex.xyz - Mesh_PivotsOS2291_g32155 );
				float3 appendResult2043_g32155 = (float3(Motion_X216_g32155 , 0.0 , Motion_Z190_g32155));
				float3 lerpResult3173_g32155 = lerp( v.vertex.xyz , ( temp_output_3474_0_g32155 + appendResult2043_g32155 ) , Wind_Mode3167_g32155);
				...
				float3 staticSwitch3312_g32155 = Vertex_Motion_Object833_g32155;
				#endif
				half3 ObjectData20_g32782 = staticSwitch3312_g32155;
				half3 WorldData19_g32782 = Vertex_Motion_World1118_g32155;
				#ifdef TVE_VERTEX_DATA_BATCHED
				...
				#endif
				float Vertex_SizeFade1740_g32155 = staticSwitch14_g32780;
				...
				half Global_ExtrasTex_G305_g32155 = break49_g32746.y;
				float lerpResult346_g32155 = lerp( 1.0 , Global_ExtrasTex_G305_g32155 , _GlobalSize);
				float ObjectData20_g32781 = ( lerpResult346_g32155 * _LocalSize );
				...
				#endif
				half Vertex_Size1741_g32155 = staticSwitch14_g32781;
				half3 Grass_Coverage2661_g32155 = half3(0,0,0);
				float3 Final_VertexPosition890_g32155 = ( ( staticSwitch14_g32782 * Vertex_SizeFade1740_g32155 * Vertex_Size1741_g32155 ) + Mesh_PivotsOS2291_g32155 + Grass_Coverage2661_g32155 );
				
				half2 Noise_UVs3274_g32155 = ( (ase_worldPos).xz * ( ( _NoiseScaleValue * 0.1 ) + _MoiseCat ) );
				float temp_output_7_0_g32755 = _NoiseMinValue;
				half Noise_Mask3162_g32155 = saturate( ( ( SAMPLE_TEXTURE2D_LOD( _NoiseTex, sampler_NoiseTex, Noise_UVs3274_g32155, 0.0 ).r - temp_output_7_0_g32755 ) / ( _NoiseMaxValue - temp_output_7_0_g32755 ) ) );
				...
				float3 vertexToFrag3225_g32155 = Noise_Tint2802_g32155;
				o.ase_texcoord7.xyz = vertexToFrag3225_g32155;
				...
				#endif
				float3 vertexValue = Final_VertexPosition890_g32155;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
			...
			half4 frag ( VertexOutput IN , half ase_vface : VFACE ) : SV_Target
			{
				...
				float4 lerpResult2779_g32155 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( IN.ase_color.a - temp_output_7_0_g32742 ) / ( ( _GradientMaxValue + _GradientCat ) - temp_output_7_0_g32742 ) ) ));
				half3 Gradient_Tint2784_g32155 = (lerpResult2779_g32155).rgb;
				float3 vertexToFrag3225_g32155 = IN.ase_texcoord7.xyz;
				half2 Noise_UVs3274_g32155 = ( (WorldPosition).xz * ( ( _NoiseScaleValue * 0.1 ) + _MoiseCat ) );
				float temp_output_7_0_g32755 = _NoiseMinValue;
				half Noise_Mask3162_g32155 = saturate( ( ( SAMPLE_TEXTURE2D( _NoiseTex, sampler_NoiseTex, Noise_UVs3274_g32155 ).r - temp_output_7_0_g32755 ) / ( _NoiseMaxValue - temp_output_7_0_g32755 ) ) );
				float4 lerpResult2800_g32155 = lerp( _NoiseTintTwo , _NoiseTintOne , Noise_Mask3162_g32155);
				half3 Noise_Tint2802_g32155 = (lerpResult2800_g32155).rgb;
				#ifdef TVE_IS_GRASS_SHADER
				float3 staticSwitch3420_g32155 = Noise_Tint2802_g32155;
				#else
				float3 staticSwitch3420_g32155 = vertexToFrag3225_g32155;
				#endif
				half2 Main_UVs15_g32155 = ( ( IN.ase_texcoord8.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				...
				half3 Main_AlbedoTinted2808_g32155 = ( Gradient_Tint2784_g32155 * staticSwitch3420_g32155 * Main_AlbedoRaw99_g32155 * float3(1,1,1) );
				...
				half3 Global_ColorsTex_RGB1700_g32155 = (temp_output_45_0_g32783).xyz;
				...
				half Main_Mask_Remap3201_g32155 = saturate( ( ( Main_Mask_Raw57_g32155 - temp_output_7_0_g32814 ) / ( _MainMaskMaxValue - temp_output_7_0_g32814 ) ) );
				float lerpResult2105_g32155 = lerp( 1.0 , Main_Mask_Remap3201_g32155 , _ColorsMaskValue);
				float3 lerpResult108_g32155 = lerp( float3( 1,1,1 ) , ( (_LocalColors).rgb * ( Global_ColorsTex_RGB1700_g32155 * staticSwitch1_g32768 ) ) , ( _GlobalColors * lerpResult2105_g32155 ));
				...
				half Global_ColorsTex_A1701_g32155 = (temp_output_45_0_g32783).w;
				...
				float3 normalizeResult1983_g32155 = normalize( ( _WorldSpaceCameraPos - WorldPosition ) );
				...
				float2 appendResult88_g32731 = (float2(tex2DNode117_g32155.a , tex2DNode117_g32155.g));
				...
				half Main_NormalY2095_g32155 = break93_g32731.y;
				...
				half4 localUSE_BUFFERS33_g32747 = USE_BUFFERS( Legacy33_g32747 , Vegetation33_g32747 , Grass33_g32747 , Objects33_g32747 , Custom33_g32747 );
				float4 break49_g32746 = localUSE_BUFFERS33_g32747;
				half Global_ExtrasTex_B156_g32155 = break49_g32746.z;
				...
				half Overlay_Mask269_g32155 = saturate( ( saturate( ( IN.ase_color.a + ( Main_NormalY2095_g32155 * Overlay_Contrast1405_g32155 ) ) ) - ( 1.0 - Overlay_Commons1365_g32155 ) ) );
				...
				half3 Main_Normal137_g32155 = appendResult91_g32731;
				float3 temp_output_13_0_g32745 = Main_Normal137_g32155;
				float3 switchResult12_g32745 = (((ase_vface>0)?(temp_output_13_0_g32745):(( temp_output_13_0_g32745 * _render_normals_options ))));
				half3 Blend_Normal312_g32155 = switchResult12_g32745;
				...
				half Global_ExtrasTex_A1033_g32155 = break49_g32746.w;
				...
				float3 normalizeResult2169_g32155 = normalize( ( _WorldSpaceCameraPos - WorldPosition ) );
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal2274_g32155 = half3(0.001,0.001,1);
				float3 worldNormal2274_g32155 = float3(dot(tanToWorld0,tanNormal2274_g32155), dot(tanToWorld1,tanNormal2274_g32155), dot(tanToWorld2,tanNormal2274_g32155));
				float dotResult2161_g32155 = dot( normalizeResult2169_g32155 , worldNormal2274_g32155 );
				float3 normalizeResult2210_g32155 = normalize( ( _WorldSpaceCameraPos - WorldPosition ) );
				...
				half Alpha5_g32759 = ( Main_AlphaRaw1203_g32155 * Billboard_Fade2175_g32155 );
				float Alpha9_g32759 = Alpha5_g32759;
				#if _ALPHATEST_ON
				clip(Alpha9_g32759 - _Cutoff);
				#endif
				half Final_Clip914_g32155 = localCustomAlphaClip9_g32759;
				
				float3 Albedo = temp_output_410_0_g32155;
				float3 Normal = Final_Normal366_g32155;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = Final_Metallic367_g32155;
				float Smoothness = lerpResult1037_g32155;
				float Occlusion = Blend_Occlusion323_g32155;
				float Alpha = Main_Alpha316_g32155;
				float AlphaClipThreshold = Final_Clip914_g32155;
				float AlphaClipThresholdShadow = 0.5;
				float3 BakedGI = 0;
				float3 RefractionColor = 1;
				float RefractionIndex = 1;
				float3 Transmission = Subsurface_Transmission884_g32155;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half2 Main_UVs15_g32155 = ( ( IN.ase_texcoord2.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g32155 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g32155 );
				float4 temp_output_51_0_g32155 = ( _MainColor * tex2DNode29_g32155 );
				half Main_Alpha316_g32155 = (temp_output_51_0_g32155).a;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half3 Noise_Tint2802_g32155 = (lerpResult2800_g32155).rgb;
				float3 vertexToFrag3225_g32155 = Noise_Tint2802_g32155;
				o.ase_texcoord2.xyz = vertexToFrag3225_g32155;
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 lerpResult2779_g32155 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( IN.ase_color.a - temp_output_7_0_g32742 ) / ( ( _GradientMaxValue + _GradientCat ) - temp_output_7_0_g32742 ) ) ));
				half3 Gradient_Tint2784_g32155 = (lerpResult2779_g32155).rgb;
				float3 vertexToFrag3225_g32155 = IN.ase_texcoord2.xyz;
				half2 Noise_UVs3274_g32155 = ( (WorldPosition).xz * ( ( _NoiseScaleValue * 0.1 ) + _MoiseCat ) );
				float temp_output_7_0_g32755 = _NoiseMinValue;
				half Noise_Mask3162_g32155 = saturate( ( ( SAMPLE_TEXTURE2D( _NoiseTex, sampler_NoiseTex, Noise_UVs3274_g32155 ).r - temp_output_7_0_g32755 ) / ( _NoiseMaxValue - temp_output_7_0_g32755 ) ) );
				float4 lerpResult2800_g32155 = lerp( _NoiseTintTwo , _NoiseTintOne , Noise_Mask3162_g32155);
				...
				float3 staticSwitch3420_g32155 = vertexToFrag3225_g32155;
				#endif
				half2 Main_UVs15_g32155 = ( ( IN.ase_texcoord3.xy * (_MainUVs).xy ) + (_MainUVs).zw );
				float4 tex2DNode29_g32155 = SAMPLE_TEXTURE2D( _MainAlbedoTex, sampler_MainAlbedoTex, Main_UVs15_g32155 );
				float4 temp_output_51_0_g32155 = ( _MainColor * tex2DNode29_g32155 );
				half3 Main_AlbedoRaw99_g32155 = (temp_output_51_0_g32155).rgb;
				half3 Main_AlbedoTinted2808_g32155 = ( Gradient_Tint2784_g32155 * staticSwitch3420_g32155 * Main_AlbedoRaw99_g32155 * float3(1,1,1) );
...
/*ASEBEGIN
Version=18600
1927;1;1906;1021;2771.432;892.4786;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;129;-1792,-896;Half;False;Property;_IsStandardShader;_IsStandardShader;205;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;364;-2176,-384;Inherit;False;Base Shader;1;;32155;856f7164d1c579d43a5cf4968a75ca43;50,1300,1,1298,1,1271,0,1962,1,1708,1,1712,3,1964,1,1969,1,1719,1,893,0,1745,1,1742,1,1715,1,1718,1,1717,1,1714,1,916,0,1949,1,1763,0,1762,0,1776,0,1646,1,1690,0,1757,0,3221,3,1981,0,2807,1,2953,1,3243,0,2172,1,2658,0,1735,0,1736,0,1734,0,1737,0,1968,0,1966,0,1733,0,878,0,1550,0,860,1,2750,0,2260,1,2261,1,2054,0,2032,0,2036,0,2060,0,2062,0,2039,0;0;15;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;529;FLOAT;530;FLOAT;531;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;653;FLOAT;629;FLOAT3;534
Node;AmplifyShaderEditor.RangedFloatNode;362;-1152,-768;Inherit;False;Property;_Float7;Float 7;204;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;141;-1568,-896;Half;False;Property;_IsLitShader;_IsLitShader;206;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;268;-1392,-896;Half;False;Property;_IsForwardPathShader;_IsForwardPathShader;207;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;81;-1984,-896;Half;False;Property;_IsCrossShader;_IsCrossShader;208;1;[HideInInspector];Create;True;0;0;True;0;False;1;0;1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-2176,-767;Half;False;Property;_render_cutoff;_render_cutoff;209;1;[HideInInspector];Create;True;4;Alpha;0;Premultiply;1;Additive;2;Multiply;3;0;True;0;False;0.5;0.719;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-1728,-769;Half;False;Property;_render_src;_render_src;211;1;[HideInInspector];Create;True;0;0;True;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;360;-1376,-384;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;356;-1376,-384;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;359;-1376,-384;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;357;-1376,-384;Float;False;True;-1;2;TVEShaderCoreGUI;0;2;BOXOPHOBIC/The Vegetation Engine/Vegetation/Cross Subsurface Lit;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;0;False;-1;True;2;True;10;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;0;True;1;1;True;20;0;True;7;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;True;17;True;3;False;-1;True;False;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;0;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;1;  Transmission Shadow;0.5,True,362;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;1;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;0;0;6;False;True;True;True;True;True;False;;True;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;361;-1376,-384;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;True;20;0;True;7;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;True;1;True;17;True;3;False;-1;True;False;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;358;-1376,-384;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;357;0;364;0
WireConnection;357;1;364;528
WireConnection;357;3;364;529
WireConnection;357;4;364;530
WireConnection;357;5;364;531
WireConnection;357;6;364;532
WireConnection;357;7;364;653
WireConnection;357;14;364;1230
WireConnection;357;8;364;534
ASEEND*/
//CHKSM=51AC17EF87F4A0E5BA3ECD4E764878D3C754B372