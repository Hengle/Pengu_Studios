	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				half3 VertexPos40_g32429 = temp_output_2283_0_g32155;
				...
				float WorldData19_g32403 = ( Bounds_Height374_g32155 * 3.14 );
				#ifdef TVE_VERTEX_DATA_BATCHED
				float staticSwitch14_g32403 = WorldData19_g32403;
				#else
				float staticSwitch14_g32403 = ObjectData20_g32403;
				#endif
				float Motion_Max_Bending1133_g32155 = staticSwitch14_g32403;
				...
				#endif
				half Variation3073_g32155 = staticSwitch14_g32408;
				half Motion_Variation284_g32427 = ( _MotionVariation_10 * Variation3073_g32155 );
				...
				half Input_Turbulence327_g32427 = Global_NoiseTex_R34_g32155;
				float2 lerpResult321_g32427 = lerp( Sine_MinusOneToOne281_g32427 , temp_cast_11 , Input_Turbulence327_g32427);
				half2 Motion_Bending2258_g32155 = ( ( _MotionAmplitude_10 * Motion_Max_Bending1133_g32155 ) * Wind_Power_103106_g32155 * Wind_DirectionOS39_g32155 * Motion_Use1056_g32155 * Global_NoiseTex_R34_g32155 * lerpResult321_g32427 );
				...
				half Angle44_g32429 = Motion_Z190_g32155;
				...
				half Angle44_g32421 = -Motion_X216_g32155;
				half Wind_Mode3167_g32155 = TVE_WindMode;
				float3 lerpResult3168_g32155 = lerp( v.vertex.xyz , ( VertexPosRotationAxis50_g32421 + ( VertexPosOtherAxis82_g32421 * cos( Angle44_g32421 ) ) + ( cross( float3(0,0,1) , VertexPosOtherAxis82_g32421 ) * sin( Angle44_g32421 ) ) ) , Wind_Mode3167_g32155);
				...
				float3 lerpResult3173_g32155 = lerp( v.vertex.xyz , ( v.vertex.xyz + appendResult2043_g32155 ) , Wind_Mode3167_g32155);
				...
				half Noise_Mask3162_g32155 = saturate( ( ( SAMPLE_TEXTURE2D_LOD( _NoiseTex, sampler_NoiseTex, Noise_UVs3274_g32155, 0.0 ).r - temp_output_7_0_g32314 ) / ( _NoiseMaxValue - temp_output_7_0_g32314 ) ) );
			...
			half4 frag ( VertexOutput IN , half ase_vface : VFACE ) : SV_Target
			{
				...
				float4 lerpResult2779_g32155 = lerp( _GradientColorTwo , _GradientColorOne , saturate( ( ( IN.ase_color.a - temp_output_7_0_g32317 ) / ( ( _GradientMaxValue + _GradientCat ) - temp_output_7_0_g32317 ) ) ));
				...
				float temp_output_7_0_g32314 = _NoiseMinValue;
				half Noise_Mask3162_g32155 = saturate( ( ( SAMPLE_TEXTURE2D( _NoiseTex, sampler_NoiseTex, Noise_UVs3274_g32155 ).r - temp_output_7_0_g32314 ) / ( _NoiseMaxValue - temp_output_7_0_g32314 ) ) );
				float4 lerpResult2800_g32155 = lerp( _NoiseTintTwo , _NoiseTintOne , Noise_Mask3162_g32155);
				half3 Noise_Tint2802_g32155 = (lerpResult2800_g32155).rgb;
				#ifdef TVE_IS_GRASS_SHADER
				...
				half3 Global_ColorsTex_RGB1700_g32155 = (temp_output_45_0_g32385).xyz;
				...
				half Main_Mask_Remap3201_g32155 = saturate( ( ( Main_Mask_Raw57_g32155 - temp_output_7_0_g32405 ) / ( _MainMaskMaxValue - temp_output_7_0_g32405 ) ) );
				float lerpResult2105_g32155 = lerp( 1.0 , Main_Mask_Remap3201_g32155 , _ColorsMaskValue);
				float3 lerpResult108_g32155 = lerp( float3( 1,1,1 ) , ( (_LocalColors).rgb * ( Global_ColorsTex_RGB1700_g32155 * staticSwitch1_g32318 ) ) , ( _GlobalColors * lerpResult2105_g32155 ));
				...
				half Global_ColorsTex_A1701_g32155 = (temp_output_45_0_g32385).w;
				...
				float2 appendResult88_g32418 = (float2(tex2DNode117_g32155.a , tex2DNode117_g32155.g));
				...
				half Main_NormalY2095_g32155 = break93_g32418.y;
				...
				half3 Main_Normal137_g32155 = appendResult91_g32418;
				float3 temp_output_13_0_g32320 = Main_Normal137_g32155;
				float3 switchResult12_g32320 = (((ase_vface>0)?(temp_output_13_0_g32320):(( temp_output_13_0_g32320 * _render_normals_options ))));
				half3 Blend_Normal312_g32155 = switchResult12_g32320;
				...
				half Alpha5_g32414 = ( Main_AlphaRaw1203_g32155 * Billboard_Fade2175_g32155 );
				float Alpha9_g32414 = Alpha5_g32414;
				#if _ALPHATEST_ON
				clip(Alpha9_g32414 - _Cutoff);
				#endif
				half Final_Clip914_g32155 = localCustomAlphaClip9_g32414;
...
/*ASEBEGIN
Version=18600
1927;7;1906;1015;2771.432;889.4786;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;364;-2176,-384;Inherit;False;Base Shader;1;;32155;856f7164d1c579d43a5cf4968a75ca43;50,1300,1,1298,1,1271,0,1708,1,1962,1,1712,3,1964,1,1969,1,1719,1,893,0,1745,1,1742,1,1718,1,1717,1,1715,1,1714,1,916,0,1949,1,1762,0,1763,0,1776,0,1646,1,1690,0,1757,0,3221,3,1981,0,2807,1,2953,1,3243,0,2172,1,2658,0,1734,0,1737,0,1733,0,1736,0,1968,0,1966,0,1735,0,878,0,1550,0,860,1,2750,0,2260,1,2261,1,2054,0,2032,0,2036,0,2060,0,2062,0,2039,0;0;15;FLOAT3;0;FLOAT3;528;FLOAT3;2489;FLOAT;529;FLOAT;530;FLOAT;531;FLOAT;1235;FLOAT3;1230;FLOAT;1461;FLOAT;1290;FLOAT;721;FLOAT;532;FLOAT;653;FLOAT;629;FLOAT3;534
...
ASEEND*/
//CHKSM=5E2246DAD836FBC11591EF40A136072B18276BBD
