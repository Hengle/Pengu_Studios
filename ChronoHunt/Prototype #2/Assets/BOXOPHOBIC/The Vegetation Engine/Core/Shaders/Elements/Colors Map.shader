	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				half4 Color_Main_RGBA49_g18780 = _MainColor;
				half TVE_SeasonOptions_X50_g18780 = TVE_SeasonOptions.x;
				half4 Color_Winter_RGBA58_g18780 = _AdditionalColor1;
				half4 Color_Spring_RGBA59_g18780 = _AdditionalColor2;
				half TVE_SeasonLerp54_g18780 = TVE_SeasonLerp;
				half4 lerpResult615_g18780 = lerp( Color_Winter_RGBA58_g18780 , Color_Spring_RGBA59_g18780 , TVE_SeasonLerp54_g18780);
				half TVE_SeasonOptions_Y51_g18780 = TVE_SeasonOptions.y;
				half4 Color_Summer_RGBA60_g18780 = _AdditionalColor3;
				half4 lerpResult608_g18780 = lerp( Color_Spring_RGBA59_g18780 , Color_Summer_RGBA60_g18780 , TVE_SeasonLerp54_g18780);
				half TVE_SeasonOptions_Z52_g18780 = TVE_SeasonOptions.z;
				half4 Color_Autumn_RGBA61_g18780 = _AdditionalColor4;
				half4 lerpResult602_g18780 = lerp( Color_Summer_RGBA60_g18780 , Color_Autumn_RGBA61_g18780 , TVE_SeasonLerp54_g18780);
				half TVE_SeasonOptions_W53_g18780 = TVE_SeasonOptions.w;
				half4 lerpResult612_g18780 = lerp( Color_Autumn_RGBA61_g18780 , Color_Winter_RGBA58_g18780 , TVE_SeasonLerp54_g18780);
				half Element_Mode55_g18780 = _ElementMode;
				half4 lerpResult597_g18780 = lerp( Color_Main_RGBA49_g18780 , ( ( TVE_SeasonOptions_X50_g18780 * lerpResult615_g18780 ) + ( TVE_SeasonOptions_Y51_g18780 * lerpResult608_g18780 ) + ( TVE_SeasonOptions_Z52_g18780 * lerpResult602_g18780 ) + ( TVE_SeasonOptions_W53_g18780 * lerpResult612_g18780 ) ) , Element_Mode55_g18780);
				half4 tex2DNode17_g18780 = tex2D( _MainTex, ( ( i.ase_texcoord1.xy * (_MainUVs).xy ) + (_MainUVs).zw ) );
				...
				half4 appendResult622_g18780 = (half4(Final_ColorsMap_RGB598_g18780 , Final_ColorsMap_A603_g18780));
				
				
				finalColor = appendResult622_g18780;
				return finalColor;
			}
			ENDCG
		}
