	...
	LOD 0
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				half temp_output_9_0_g18657 = lerpResult378_g18614;
				half sRGB8_g18657 = temp_output_9_0_g18657;
				half localGammaToLinearFloatFast8_g18657 = GammaToLinearFloatFast( sRGB8_g18657 );
				#ifdef UNITY_COLORSPACE_GAMMA
				float staticSwitch1_g18657 = temp_output_9_0_g18657;
				#else
				float staticSwitch1_g18657 = localGammaToLinearFloatFast8_g18657;
				#endif
				half Final_Wetness_A250_g18614 = staticSwitch1_g18657;
